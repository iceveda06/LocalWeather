...
$(document).ready(function() {
    ...
    form.addEventListener('submit', function(e) {
        ...
        $.get("https://maps.googleapis.com/maps/api/geocode/json?" + 'address=' + value + "&key=AIzaSyA7kvvU8hEBBmTg3Fw_dteJx4DJ0BvuOG0", function(locate) {
            ...
            $.get("https://api.openweathermap.org/data/2.5/weather?" + 'lat=' + lati + '&lon=' + lng + "&units=imperial" + "&APPID=0f282dc00daa96e733691054692f8b33", function(weather) {
...
var ctemp = Math.round((((((weather.main.temp) - 32) * 5) / 9)*100)/100);
            ...
            $.get("https://api.openweathermap.org/data/2.5/forecast/daily?" + 'lat=' + lati + '&lon=' + lng + "&units=imperial" + "&APPID=0f282dc00daa96e733691054692f8b33", function(forecast) {
                console.log("https://api.openweathermap.org/data/2.5/forecast/daily?" + 'lat=' + lati + '&lon=' + lng + "&units=imperial" + "&APPID=0f282dc00daa96e733691054692f8b33")
                var divsToAppend = "";
                var divsToAppendC = "";
